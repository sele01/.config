...
hl.config({
    input = {
        kb_layout = "us,us",
        kb_variant = "dvorak,",
        kb_options = "grp:win_space_toggle,lv3:win_switch,caps:swapescape",
    ...
    master = {
        ...
        new_status = "master",         
        orientation = "left",          
        allow_small_split = true,      -- Enables top/bottom sub-splitting on the master side
...
hl.window_rule({ name = "popups-read", match = { workspace = "name:special:read" }, float = true })
hl.window_rule({ name = "popups-notes", match = { workspace = "name:special:notes" }, float = true })
...
-------------------------------
hl.bind(mainMod .. "+M", hl.dsp.layout("swapwithmaster"))      -- Fixed dispatcher argument
hl.bind(mainMod .. "+J", hl.dsp.layout("cyclenext"))             
hl.bind(mainMod .. "+K", hl.dsp.layout("cycleprev"))             
hl.bind(mainMod .. "+I", hl.dsp.layout("addmaster"))             
hl.bind(mainMod .. "+SHIFT+I", hl.dsp.layout("removemaster"))    
